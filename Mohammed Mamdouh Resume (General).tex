...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: JavaScript, TypeScript, HTML/CSS, SQL, Java, Python, C/C++, Assembly, C\#, Go} \\
     ...
     \textbf{Libraries/Tools}{: Numpy, Pandas, Keras, Tensorflow, PyTorch, Scikit-Learn, Seaborn, Librosa, Matplotlib, Git, Linux, Figma, Google Cloud, Microsoft Products} \\
    }}
 \end{itemize}
